...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/api/**': {
        // target: "http://ibeacon.yikecha.net:8009",
        // target: "http://192.168.0.117:8009",
        target: "http://192.168.0.166:8009",
        // target: "http://120.79.1.166:8009",
        // target: "http://192.168.218.179:80",
        changeOrigin: true,
        pathRewrite: {
          '^/api': ''
        }
