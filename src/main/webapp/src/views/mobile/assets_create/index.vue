<template>
  <div class='mobile_assets_create_wrap'>
       <div class="assets_create_box assets_upload_box">
            ...
            <div class="cell_item">
                <div class="cell_item_box">
                    <Field clearable label="资产id" required v-model="createData.assetID" placeholder="请输入资产id"/>
                </div>
            </div>
            <div class="cell_item">
                <div class="cell_item_box">
            ...
            <div class="cell_item">
                <div class="cell_item_box">
                    <div @click="statusDialogShow=true">
            ...
            <div class="cell_item">
                <div class="cell_item_box">
                        <!-- <Field label="院区（若mac存在则必填）" required v-model="createData.academy"  placeholder="请输入院区名"/> -->
            ...
            if(this.createData.mac.trim()&&!this.createData.architecture.trim()){
                ...
                .then((res)=>{
                    ...
                    if(res.data.msg==='ok'){
                        ...
                        this.$axios.post(NET_PORT.assetsCreate,
                        datas
                        )
                        .then((response)=>{
                            if(response.data.msg==='ok'){
                                ...
                                Toast.success('保存成功！');
                                setTimeout(()=>{
                                    this.$router.push('/mobile/assets_manage')
                                },2000)
