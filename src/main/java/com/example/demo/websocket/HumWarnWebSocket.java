...
@ServerEndpoint(value = "/hum/warn/websocket/{verification}")
@Component
public class HumWarnWebSocket {
	
	
	
    private static CopyOnWriteArraySet<HumWarnWebSocket> webSocketSet = new CopyOnWriteArraySet<HumWarnWebSocket>();
...
//定时任务核心代码
    public static CopyOnWriteArraySet<HumWarnWebSocket> getWebSocketSet() {
        return webSocketSet;
    }

    public static void setWebSocketSet(CopyOnWriteArraySet<HumWarnWebSocket> webSocketSet) {
    	HumWarnWebSocket.webSocketSet = webSocketSet;
    }
