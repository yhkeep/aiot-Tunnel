...
@ServerEndpoint(value = "/map3/websocket/{verification}")  //携带楼层，进行过滤
@Component
public class Map3DWebSocket {
	
	
	
    //concurrent包的线程安全Set，用来存放每个客户端对应的MyWebSocket对象。
//	在外部可以获取此连接的所有websocket对象，并能对其触发消息发送功能，我们的定时发送核心功能的实现在与此变量 
    private static CopyOnWriteArraySet<Map3DWebSocket> webSocketSet = new CopyOnWriteArraySet<Map3DWebSocket>();
...
//定时任务核心代码
    public static CopyOnWriteArraySet<Map3DWebSocket> getWebSocketSet() {
        return webSocketSet;
    }

    public static void setWebSocketSet(CopyOnWriteArraySet<Map3DWebSocket> webSocketSet) {
    	Map3DWebSocket.webSocketSet = webSocketSet;
    }
